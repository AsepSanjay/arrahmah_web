...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a href="index-2.html" class="default-logo"><img src="images/arrahmah.ico" alt="Logo"></a>
                    <a href="index-2.html" class="default-retina-logo"><img src="images/logo%402x.png" alt="Logo" width="199" height="30"></a>
                    <a href="index-2.html" class="sticky-logo"><img src="images/arrahmah.ico" alt="Logo"></a>
                ...
                <ul class="sf-menu dd-menu pull-right" role="menu">
                    ...
                    <li><a href="events.html">Kegiatan</a>
                        <ul>
                            <li><a href="events.html">Kegiatan Yayasan</a></li>
                        </ul>
                    </li>
                    <li><a href="gallery-caption-2cols.html">Galeri</a>
                        <ul>
                            ...
                            <div class="flex-caption-table">
                                <div class="flex-caption-cell">
                                    <div class="flex-caption-text">
                                        <h2>Yayasan Pendidikan Islam<br>Ar Rahmah</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="flex-caption-table">
                                <div class="flex-caption-cell text-align-center">
                                    <div class="flex-caption-text text-align-center">
                                        <h2>Ciptakan Pendidikan Bernuansa Islami</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="content">
            ...
            <div class="padding-tb75 position-relative">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="block-title">Kegiatan yang akan datang</h2>
                            <div class="spacer-20"></div>
                                <ul class="events-compact-list">
                                @foreach($event as $data)
                                    <li class="event-list-item">    
                                        <span class="event-date">
                                            <span class="date">{{ Carbon\Carbon::parse($data->tanggal_kegiatan)->day }}</span>
                                            <span class="month">{{ Carbon\Carbon::parse($data->tanggal_kegiatan)->format('M') }}</span>
                                            <span class="year">{{ Carbon\Carbon::parse($data->tanggal_kegiatan)->year }}</span>
                                        </span>
                                        <div class="event-list-cont">
                                            <span class="meta-data">{{$data->tanggal_kegiatan}}</span>
                                            <h4 class="post-title"><a href="#">{{$data->nama_kegiatan}}</a></h4>
                            ...
                            <div class="gallery-updates cols2 clearfix">
                                <ul>
                                    ...
                                    <li class="grid-item format-image">
                                        <a href="{{url('file/foto/'.$key->foto)}}" class="media-box magnific-image"> <img src= "{{url('file/foto/'.$key->foto)}}" alt=""> </a>
                                    </li>
                                    @endforeach
                                </ul>
            ...
            <div class="padding-tb75 padding-b0">
                <div class="container">
                    <div class="text-align-center">
                        <h2 class="block-title block-title-center">Artikel Terkait</h2>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        @foreach($artikel_all as $key)
                            <li class="item">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="{{url('file/foto/'.$key->foto)}}" alt="" class="img-responsive">
                                    </div>
            ...
            <!-- Partner Carousel -->
            <div class="partner-carousel" style="background: #1E824C; margin-top: -1px" >
                <div class="container">
                    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <h2 class="block-title">Terbaru dari kami</h2>
                            <p></p>
                        </div>
                                            ...
                                            <div class="grid-item blog-grid-item format-standard">
                                                <div class="grid-item-inner">
                                                    <a href="single-event.html" class="media-box">
                                                        <img src="{{url('file/foto/'.$key->foto)}}" alt="" style="width: 400px; max-height: 200px">
                                                    </a>
                                                    <div class="grid-item-content">
                                                        <h3 class="post-title"><a href="single-post.html">{{$key->judul}}</a></h3>
                                                        <span class="meta-data">{{$key->tanggal}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
