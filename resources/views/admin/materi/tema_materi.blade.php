...
@section('content')
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Data Tema Materi</h1>
      <ol class="breadcrumb">
        <li><a href="{{url('/admin')}}">Beranda</a></li>
        <li class="active">Materi</li>
        <li class="active">Data Tema Materi</li>
      </ol>
    </div><br>
