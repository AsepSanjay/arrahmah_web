...
<div class="page">
  <div class="page-header">
      <h1 class="page-title">Sunting Materi</h1>
      <ol class="breadcrumb">
        <li><a href="{{url('/admin')}}">Beranda</a></li>
        <li class="active">Materi</li>
        <li class="active">Perbarui Materi</li>
      </ol>
  </div>
      ...
      <div class="col-xlg-6 col-md-12">
        ...
        <div class="widget widget-shadow widget-responsive" id="widgetLineareaColor">
          <div class="widget-content widget-radius bg-white">
            ...
            <form class="form-horizontal" method="POST" action="{{url('save_edited_materi')}}" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id" value="{{$materi->id}}">
              ...
              <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tema" placeholder="Masukkan tema materi"
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input name="video" type="text" class="form-control" id="video" value="{{$materi->video}}" placeholder="Masukkan tautan video materi" >
                </div>
              </div>
