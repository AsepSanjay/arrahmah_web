...
@section('content')
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Data Kuis</h1>
      <ol class="breadcrumb">
        <li><a href="{{url('/admin')}}">Beranda</a></li>
        <li class="active">Admin</li>
        <li class="active">Data Kuis</li>
      </ol>
    </div><br>
          ...
          <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
            ...
            <?php $i = 1; ?>
              ...
              <tr>
                ...
                <td>{{$data->tema_kuis}}</td>
                <td></td>
                <td>
                  <a href="{{route('update_kuis',$data->id)}}">
                    <button type="button" class="btn btn-icon btn-warning" title="Lihat"><i class="icon wb-eye" aria-hidden="true"></i></button>
                  </a>
