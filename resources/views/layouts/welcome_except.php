...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a href="index-2.html" class="default-logo"><img src="{{url('images/arrahmah.ico')}}" alt="Logo"></a>
                    <a href="index-2.html" class="default-retina-logo"><img src="{{url('images/logo%402x.png')}}" alt="Logo" width="199" height="30"></a>
                    <a href="index-2.html" class="sticky-logo"><img src="{{url('images/arrahmah.ico')}}" alt="Logo"></a>
                    <a href="index-2.html" class="sticky-retina-logo"><img src="{{url('images/sticky-logo%402x.png')}}" alt="Logo" width="199" height="30"></a>
                </div>
