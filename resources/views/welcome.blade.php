                            ...
                            <div class="gallery-updates cols2 clearfix">
                                <ul>
                                    ...
                                    <li class="grid-item format-image">
                                        <a href="{{url('file/foto/'.$key->foto)}}" class="media-box magnific-image"> <img src= "{{url('file/foto/'.$key->foto)}}" alt="" style="height: 190px;"> </a>
                                    </li>
                                    @endforeach
                                </ul>
                                <div class="gallery-updates-overlay">
                                    <i class="icon-multiple-image"></i> Gambar gambar dari galeri kami
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <h2 class="block-title">Artikel Teratas</h2>
                            <p></p>
                        </div>
                                            ...
                                            <div class="grid-item blog-grid-item format-standard">
                                                <div class="grid-item-inner">
                                                    ...
                                                    <div class="grid-item-content">
                                                        <h3 class="post-title"><a href="{{route('read_art',$key->id)}}">{{$key->judul}}</a></h3>
