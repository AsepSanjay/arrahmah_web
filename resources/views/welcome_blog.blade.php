...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a href="{{('/')}}" class="default-logo"><img src="{{url('images/saladin.ico')}}" alt="Logo"></a>
                    <a href="{{('/')}}" class="default-retina-logo"><img src="{{url('images/logo%402x.png')}}" alt="Logo" width="199" height="30"></a>
                    <a href="{{('/')}}" class="sticky-logo"><img src="{{url('images/saladin.ico')}}" alt="Logo"></a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="widget footer_widget">
                        ...
                        <p><img src="images/saladin.ico" alt="" style="width: 70px;"></p>
