...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a href="{{url('/')}}" class="default-logo"><img src="{{url('images/saladin.ico')}}" alt="Logo"></a>
                    <a href="{{url('/')}}" class="default-retina-logo"><img src="{{url('images/logo%402x.png')}}" alt="Logo" width="199" height="30"></a>
                    <a href="{{url('/')}}" class="sticky-logo"><img src="{{url('images/saladin.ico')}}" alt="Logo"></a>
        	...
        	<div class="container">
            	<div class="row">
                	...
                	<div class="col-md-8 content-block">
                        ...
                        <!-- Pagination -->
                        <ul class="pager">
                            <li class="pull-left"><a href="{{url('/artikel')}}" onclick="javascript:history.back()">&larr; Kembali</a></li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="widget footer_widget">
                        ...
                        <p><img src="{{url('/images/saladin.ico')}}" alt="" style="height: 100px;"></p>
